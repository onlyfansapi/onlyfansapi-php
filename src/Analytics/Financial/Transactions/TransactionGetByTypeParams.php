 ...
 * }
 */
final class TransactionGetByTypeParams implements BaseModel
{
    /** @use SdkModel<TransactionGetByTypeParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new TransactionGetByTypeParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TransactionGetByTypeParams::with(accountIDs: ..., endDate: ..., startDate: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TransactionGetByTypeParams)
     *   ->withAccountIDs(...)
     *   ->withEndDate(...)
     *   ->withStartDate(...)
     * ```
