...
use OnlyFansAPI\DataExports\DataExportListResponse\Data\Data\Account;

/**
 * @phpstan-import-type AccountShape from \OnlyFansAPI\DataExports\DataExportListResponse\Data\Data\Account
 *
...
final class Data implements BaseModel
{
    ...
    #[Optional('download_url_expires_at')]
    ...
    public static function with(
        ...
        ?string $downloadURLExpiresAt = null,
        ?string $endDate = null,
        ...
        null !== $downloadURLExpiresAt && $self['downloadURLExpiresAt'] = $downloadURLExpiresAt;
    ...
    public function withDownloadURLExpiresAt(string $downloadURLExpiresAt): self
    {
        $self = clone $this;
