...
use Onlyfansapi\Banking\Details\DetailGetBankDetailsResponse\Data\Payout\Fields\BankName\Label;
use Onlyfansapi\Core\Attributes\Optional;
use Onlyfansapi\Core\Concerns\SdkModel;
use Onlyfansapi\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type LabelShape from \Onlyfansapi\Banking\Details\DetailGetBankDetailsResponse\Data\Payout\Fields\BankName\Label
 *
 * @phpstan-type BankNameShape = array{
 ...
 * }
 */
final class BankName implements BaseModel
{
    /** @use SdkModel<BankNameShape> */
    use SdkModel;
