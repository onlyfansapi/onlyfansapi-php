...
namespace OnlyFansAPI\Chats\ChatHideResponse;

use OnlyFansAPI\Chats\ChatHideResponse\_Meta\_Cache;
use OnlyFansAPI\Chats\ChatHideResponse\_Meta\_Credits;
use OnlyFansAPI\Chats\ChatHideResponse\_Meta\_RateLimits;
use OnlyFansAPI\Core\Attributes\Optional;
use OnlyFansAPI\Core\Concerns\SdkModel;
use OnlyFansAPI\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type _CacheShape from \OnlyFansAPI\Chats\ChatHideResponse\_Meta\_Cache
 * @phpstan-import-type _CreditsShape from \OnlyFansAPI\Chats\ChatHideResponse\_Meta\_Credits
 * @phpstan-import-type _RateLimitsShape from \OnlyFansAPI\Chats\ChatHideResponse\_Meta\_RateLimits
 *
