...
namespace OnlyFansAPI\Fans\FanSetCustomNameResponse\Data;
 ...
 *   isMuted?: bool|null,
 *   newPostsAfterExpireCount?: int|null,
 *   newPrice?: int|null,
 *   price?: int|null,
...
final class SubscribedByData implements BaseModel
{
    ...
    #[Optional]
    public ?int $newPostsAfterExpireCount;
    ...
    public static function with(
        ...
        ?bool $isMuted = null,
        ?int $newPostsAfterExpireCount = null,
        ?int $newPrice = null,
        ?int $price = null,
        ...
        null !== $newPostsAfterExpireCount && $self['newPostsAfterExpireCount'] = $newPostsAfterExpireCount;
    ...
    public function withNewPostsAfterExpireCount(
        int $newPostsAfterExpireCount
    ): self {
        $self = clone $this;
        $self['newPostsAfterExpireCount'] = $newPostsAfterExpireCount;
