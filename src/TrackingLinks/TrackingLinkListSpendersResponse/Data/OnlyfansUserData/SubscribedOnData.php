...
namespace Onlyfansapi\TrackingLinks\TrackingLinkListSpendersResponse\Data\OnlyfansUserData;
 ...
 *   subscribesSumm?: float|null,
 *   tipsSumm?: int|null,
 *   totalSumm?: float|null,
...
final class SubscribedOnData implements BaseModel
{
    ...
    public static function with(
        ...
        ?float $subscribesSumm = null,
        ?int $tipsSumm = null,
        ?float $totalSumm = null,
    ...
    public function withMessagesSumm(float $messagesSumm): self
    {
        $self = clone $this;
    ...
    public function withSubscribesSumm(float $subscribesSumm): self
    {
        $self = clone $this;
    ...
    public function withTotalSumm(float $totalSumm): self
    {
        $self = clone $this;
