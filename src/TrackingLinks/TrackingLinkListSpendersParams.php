 ...
 *
 * @see Onlyfansapi\Services\TrackingLinksService::listSpenders()
 *
 * @phpstan-type TrackingLinkListSpendersParamsShape = array{
 *   account: string, limit?: int|null, minSpend?: float|null, offset?: int|null
 * }
 */
final class TrackingLinkListSpendersParams implements BaseModel
{
    /** @use SdkModel<TrackingLinkListSpendersParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new TrackingLinkListSpendersParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TrackingLinkListSpendersParams::with(account: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TrackingLinkListSpendersParams)->withAccount(...)
     * ```
     */
