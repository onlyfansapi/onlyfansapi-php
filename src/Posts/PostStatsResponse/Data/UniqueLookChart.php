...
/**
 * @phpstan-type UniqueLookChartShape = array{count?: int|null, date?: string|null}
 */
final class UniqueLookChart implements BaseModel
{
    /** @use SdkModel<UniqueLookChartShape> */
    use SdkModel;
