...
final class HasNewTicketReplies implements BaseModel
{
    ...
    #[Optional('appeal_form')]
    public ?bool $appealForm;
    ...
    public static function with(
        ...
        null !== $appealForm && $self['appealForm'] = $appealForm;
    ...
    public function withAppealForm(bool $appealForm): self
    {
        $self = clone $this;
        $self['appealForm'] = $appealForm;
