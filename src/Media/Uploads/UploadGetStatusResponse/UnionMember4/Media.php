...
namespace OnlyFansAPI\Media\Uploads\UploadGetStatusResponse\UnionMember4;

use OnlyFansAPI\Core\Attributes\Optional;
use OnlyFansAPI\Core\Concerns\SdkModel;
use OnlyFansAPI\Core\Contracts\BaseModel;
use OnlyFansAPI\Media\Uploads\UploadGetStatusResponse\UnionMember4\Media\Additional;
use OnlyFansAPI\Media\Uploads\UploadGetStatusResponse\UnionMember4\Media\Thumb;

/**
 * @phpstan-import-type AdditionalShape from \OnlyFansAPI\Media\Uploads\UploadGetStatusResponse\UnionMember4\Media\Additional
 * @phpstan-import-type ThumbShape from \OnlyFansAPI\Media\Uploads\UploadGetStatusResponse\UnionMember4\Media\Thumb
 *
