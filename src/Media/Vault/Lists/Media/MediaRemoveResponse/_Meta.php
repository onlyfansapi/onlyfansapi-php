...
namespace OnlyFansAPI\Media\Vault\Lists\Media\MediaRemoveResponse;

use OnlyFansAPI\Core\Attributes\Optional;
use OnlyFansAPI\Core\Concerns\SdkModel;
use OnlyFansAPI\Core\Contracts\BaseModel;
use OnlyFansAPI\Media\Vault\Lists\Media\MediaRemoveResponse\_Meta\_Cache;
use OnlyFansAPI\Media\Vault\Lists\Media\MediaRemoveResponse\_Meta\_Credits;
use OnlyFansAPI\Media\Vault\Lists\Media\MediaRemoveResponse\_Meta\_RateLimits;

/**
 * @phpstan-import-type _CacheShape from \OnlyFansAPI\Media\Vault\Lists\Media\MediaRemoveResponse\_Meta\_Cache
 * @phpstan-import-type _CreditsShape from \OnlyFansAPI\Media\Vault\Lists\Media\MediaRemoveResponse\_Meta\_Credits
 * @phpstan-import-type _RateLimitsShape from \OnlyFansAPI\Media\Vault\Lists\Media\MediaRemoveResponse\_Meta\_RateLimits
 *
