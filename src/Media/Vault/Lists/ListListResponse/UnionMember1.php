...
use OnlyFansAPI\Media\Vault\Lists\ListListResponse\UnionMember1\_Meta;
use OnlyFansAPI\Media\Vault\Lists\ListListResponse\UnionMember1\Data;

/**
 * Success (lightweight=true).
 *
 * @phpstan-import-type _MetaShape from \OnlyFansAPI\Media\Vault\Lists\ListListResponse\UnionMember1\_Meta
 * @phpstan-import-type DataShape from \OnlyFansAPI\Media\Vault\Lists\ListListResponse\UnionMember1\Data
 *
