...
namespace Onlyfansapi\Media\Vault\Lists\ListDeleteResponse;

use Onlyfansapi\Core\Attributes\Optional;
use Onlyfansapi\Core\Concerns\SdkModel;
use Onlyfansapi\Core\Contracts\BaseModel;
use Onlyfansapi\Media\Vault\Lists\ListDeleteResponse\_Meta\_Cache;
use Onlyfansapi\Media\Vault\Lists\ListDeleteResponse\_Meta\_Credits;
use Onlyfansapi\Media\Vault\Lists\ListDeleteResponse\_Meta\_RateLimits;

/**
 * @phpstan-import-type _CacheShape from \Onlyfansapi\Media\Vault\Lists\ListDeleteResponse\_Meta\_Cache
 * @phpstan-import-type _CreditsShape from \Onlyfansapi\Media\Vault\Lists\ListDeleteResponse\_Meta\_Credits
 * @phpstan-import-type _RateLimitsShape from \Onlyfansapi\Media\Vault\Lists\ListDeleteResponse\_Meta\_RateLimits
 *
