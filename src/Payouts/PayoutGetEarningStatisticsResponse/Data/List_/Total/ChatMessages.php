...
/**
 * @phpstan-type ChatMessagesShape = array{
 *   totalGross?: float|null, totalNet?: float|null
 * }
 */
final class ChatMessages implements BaseModel
{
    /** @use SdkModel<ChatMessagesShape> */
    use SdkModel;
