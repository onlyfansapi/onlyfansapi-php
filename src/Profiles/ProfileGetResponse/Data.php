 ...
 *   referalBonusSummForReferer?: int|null,
...
final class Data implements BaseModel
{
    ...
    #[Optional]
    public ?int $referalBonusSummForReferer;
    ...
    public static function with(
        ...
        ?int $referalBonusSummForReferer = null,
        ...
        null !== $referalBonusSummForReferer && $self['referalBonusSummForReferer'] = $referalBonusSummForReferer;
    ...
    public function withReferalBonusSummForReferer(
        int $referalBonusSummForReferer
    ): self {
        $self = clone $this;
        $self['referalBonusSummForReferer'] = $referalBonusSummForReferer;
