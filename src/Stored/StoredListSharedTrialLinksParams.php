 ...
 *
 * @see Onlyfansapi\Services\StoredService::listSharedTrialLinks()
 *
 * @phpstan-type StoredListSharedTrialLinksParamsShape = array{
 ...
 * }
 */
final class StoredListSharedTrialLinksParams implements BaseModel
{
    /** @use SdkModel<StoredListSharedTrialLinksParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * Filter by one or more tag names or slugs. Accepts CSV or repeated array values (`filter[tags][]=...`) and matches any tag. Tag namespace is shared with owned Free Trial Links.
     */
    #[Optional]
