...
use OnlyFansAPI\Engagement\Messages\MassMessages\MassMessageChartResponse\Data\GroupMessages\Chart;

/**
 * @phpstan-import-type ChartShape from \OnlyFansAPI\Engagement\Messages\MassMessages\MassMessageChartResponse\Data\GroupMessages\Chart
 *
 * @phpstan-type GroupMessagesShape = array{
 *   chart?: list<Chart|ChartShape>|null, delta?: float|null, total?: int|null
 * }
 */
final class GroupMessages implements BaseModel
{
    /** @use SdkModel<GroupMessagesShape> */
    use SdkModel;
