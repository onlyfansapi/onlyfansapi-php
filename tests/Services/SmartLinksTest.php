...
final class SmartLinksTest extends TestCase
{
    ...
    public function testListClicks(): void
    {
        ...
        $result = $this->client->smartLinks->listClicks('corrupti');
    ...
    public function testListConversions(): void
    {
        ...
        $result = $this->client->smartLinks->listConversions('assumenda');
    ...
    public function testListFans(): void
    {
        ...
        $result = $this->client->smartLinks->listFans('alias');
    ...
    public function testListSpenders(): void
    {
        ...
        $result = $this->client->smartLinks->listSpenders('delectus');
    ...
    public function testRetrieveCohortArps(): void
    {
        ...
        $result = $this->client->smartLinks->retrieveCohortArps('placeat');
    ...
    public function testRetrieveStats(): void
    {
        ...
        $result = $this->client->smartLinks->retrieveStats('aspernatur');
