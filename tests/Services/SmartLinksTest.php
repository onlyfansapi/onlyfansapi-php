...
final class SmartLinksTest extends TestCase
{
    ...
    public function testListClicks(): void
    {
        ...
        $result = $this->client->smartLinks->listClicks('quos');
    ...
    public function testListConversions(): void
    {
        ...
        $result = $this->client->smartLinks->listConversions('incidunt');
    ...
    public function testListFans(): void
    {
        ...
        $result = $this->client->smartLinks->listFans('quaerat');
    ...
    public function testListSpenders(): void
    {
        ...
        $result = $this->client->smartLinks->listSpenders('corrupti');
    ...
    public function testRetrieveCohortArps(): void
    {
        ...
        $result = $this->client->smartLinks->retrieveCohortArps('occaecati');
    ...
    public function testRetrieveStats(): void
    {
        ...
        $result = $this->client->smartLinks->retrieveStats('voluptatibus');
